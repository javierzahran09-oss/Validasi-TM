function hitung() {
  ...
  let kwhP2 = (Vsec_avg * Ipri_avg * cosphi * sqrt3) / 1000;
...
if (kwhP2 > 0) {
  ...
  Rata-rata V Sekunder : ${Vsec_avg.toFixed(2)} V<br>
  Rata-rata V Primer : ${Vpri_avg.toFixed(0)} V<br>
  Rata-rata I Primer : ${Ipri_avg.toFixed(2)} A<br>
